...
# 共通処理
    ...
    return render(request, 'vamos/index.html', params)
...
# 共通処理
    ...
    return render(request, 'vamos/groups.html', params)
...
def creategroup(request):
    ...
    return redirect(to='/vamos/groups')
...
def post(request):
 ...
 # 共通処理
    ...
    return render(request, 'vamos/post.html', params)
...
def share(request, share_id):
    ...
    if request.method == 'POST':
        ...
        share_msg.save()
        # メッセージを設定
        messages.success(request, 'シェアしました！')
        return redirect(to='/vamos')
    ...
    return render(request, 'vamos/share.html', params)
